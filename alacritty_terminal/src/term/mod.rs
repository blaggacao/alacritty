...
use crate::index::{self, Column, Direction, IndexRange, Line, Point, Side};
...
impl<'a, C> RenderableCellsIter<'a, C> {
    ...
    fn is_selected(&mut self, point: Point) -> bool {
...
impl<T> Term<T> {
    ...
    //      -> `cat /tmp/xxx && sleep infinity` + search
    //
        ...
        T: EventListener,
    {
        ...
        if point.line >= display_offset + num_lines {
            ...
            self.scroll_display(Scroll::Lines(lines as isize));
    ...
    fn clear_screen(&mut self, mode: ansi::ClearMode) {
        ...
        match mode {
            ...
            ansi::ClearMode::Below => {
                ...
                if cursor.line < self.num_lines() - 1 {
